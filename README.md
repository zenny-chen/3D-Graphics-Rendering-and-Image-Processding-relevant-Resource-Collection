...
- [Clipmap 在开放世界中的实战应用](https://zhuanlan.zhihu.com/p/372696893)
...
- Direct3D 中对 3D 纹理进行线性插值的算法：

![texture3d_sampling](images/texture3d_sampling.png)
...
- [10｜几何（基本表示方法）](https://mp.weixin.qq.com/s?__biz=MzU1MjMyODgwMg==&mid=2247486219&idx=1&sn=91dcf68a4c9ac06f97cd85021295b505)
...
- **Point Triangle**: 对于 Direct3D， 使用 [**D3D12_FILL_MODE_SOLID**](https://learn.microsoft.com/en-us/windows/win32/api/d3d12/ne-d3d12-d3d12_fill_mode) 填充模式，且图元拓扑选用 [**D3D_PRIMITIVE_TOPOLOGY_POINTLIST**](https://learn.microsoft.com/en-us/windows/win32/api/d3dcommon/ne-d3dcommon-d3d_primitive_topology)，然后可以在 vertex shader 中通过指定输出 [**PSIZE**](https://learn.microsoft.com/en-us/windows/win32/direct3dhlsl/dx-graphics-hlsl-semantics) 来设置点的大小；对于 Vulkan 则使用 [**VK_POLYGON_MODE_POINT**](https://registry.khronos.org/vulkan/specs/latest/man/html/VkPolygonMode.html) 多边形填充模式，且图元拓扑选用 [**VK_POLYGON_MODE_POINT**](https://registry.khronos.org/vulkan/specs/latest/man/html/VkPrimitiveTopology.html)，然后可以在 vertex shader 中通过指定 [**gl_PointSize**](https://registry.khronos.org/OpenGL-Refpages/gl4/html/gl_PointSize.xhtml) 来设置点的大小。
- **Line Triangle**： 对于 Direct3D，使用 [**D3D12_FILL_MODE_WIREFRAME**](https://learn.microsoft.com/en-us/windows/win32/api/d3d12/ne-d3d12-d3d12_fill_mode) 填充模式，且图元拓扑选用 [**D3D_PRIMITIVE_TOPOLOGY_TRIANGLELIST**](https://learn.microsoft.com/en-us/windows/win32/api/d3dcommon/ne-d3dcommon-d3d_primitive_topology) 等；对于 Vulkan，使用 [**VK_POLYGON_MODE_LINE**](https://registry.khronos.org/vulkan/specs/latest/man/html/VkPolygonMode.html)，且图元拓扑选用 [**VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST**](https://registry.khronos.org/vulkan/specs/latest/man/html/VkPrimitiveTopology.html) 等，然后可以在 vertex shader 中通过指定 [**lineWidth**](https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineRasterizationStateCreateInfo.html) 来设置线宽大小。
...
- [Tessellation Stages](https://learn.microsoft.com/en-us/windows/win32/direct3d11/direct3d-11-advanced-stages-tessellation)
- [10 Hull Shader Stage](https://microsoft.github.io/DirectX-Specs/d3d/archive/D3D11_3_FunctionalSpec.htm#10%20Hull%20Shader%20Stage)
- [11 Tessellator](https://microsoft.github.io/DirectX-Specs/d3d/archive/D3D11_3_FunctionalSpec.htm#11%20Tessellator)
...
- [Vulkan Mesh Shading](https://docs.vulkan.org/spec/latest/chapters/VK_NV_mesh_shader/mesh.html)
...
- [Viewports and Clipping (Direct3D 9)](https://learn.microsoft.com/en-us/windows/win32/direct3d9/viewports-and-clipping)
- [User clip planes on feature level 9 hardware](https://learn.microsoft.com/en-us/windows/win32/direct3dhlsl/user-clip-planes-on-10level9)
- [Clip Distance](https://wikis.khronos.org/opengl/Vertex_Post-Processing#User-defined_clipping)
- [gl_CullDistance](https://registry.khronos.org/OpenGL-Refpages/gl4/html/gl_CullDistance.xhtml)
- [SV_CullDistance\[n\]](https://learn.microsoft.com/en-us/windows/win32/direct3dhlsl/dx-graphics-hlsl-semantics#system-value-semantics)
...
- [2025年终总结 - 微分几何助力突破具身智能发展的瓶颈](https://mp.weixin.qq.com/s?__biz=MzA3NTM4MzY1Mg==&mid=2650817969&idx=1&sn=ab6a8756d3b94e4430fa367e817e2065)
...
- [13｜光线追踪（基本原理）](https://mp.weixin.qq.com/s?__biz=MzU1MjMyODgwMg==&mid=2247486491&idx=1&sn=2df323822350560401bacefcf12f9216)
...
- [15｜ 光线追踪（渲染方程与全局光照）](https://mp.weixin.qq.com/s?__biz=MzU1MjMyODgwMg==&mid=2247486569&idx=1&sn=a4fefe61936f9d9e2408f79f076d5d44)
- [Karma渲染降噪实战指南：从噪点分析到画面净化](https://www.bilibili.com/video/BV1aPPUzUEdK/)
- [一张图搞定SDF的概念](https://blog.csdn.net/pizi0475/article/details/49489605/)
- [2D平面基本图形SDF推导01](https://zhuanlan.zhihu.com/p/420700051)
- [Generating signed distance fields on the GPU with ray maps](https://link.springer.com/epdf/10.1007/s00371-019-01683-w?shared_access_token=pB5wi-VcR-e_XpNCLatyNfe4RwlQNchNByi7wbcMAY7RISE5VfuFHi-mJXqXmpaoGR0ccxOG4tawSHvzrz0-9COsfOBy36eHIe5kAegZXdewbFK2TuWpoC-Vxm4tNu8CTCy6vrM2xGjC_NK7IjfRDg%3D%3D)
...
- [Faithful Contouring：无需水密化、无需 SDF 场，1024³ 体素化 1 秒内搞定 | Tech Blog](https://mp.weixin.qq.com/s?__biz=MzkyMjY1MzIwMA==&mid=2247484492&idx=1&sn=7146a9e5b649ec853432e8e2a2198567)
...
- [HLOD(Hierarchical Level of Detail)](https://zhuanlan.zhihu.com/p/400736239)
...
- [Welcome to the AMD FidelityFX™ SDK 1.1.2](https://github.com/GPUOpen-LibrariesAndSDKs/FidelityFX-SDK)
...
- [Introducing Arm Accuracy Super Resolution](https://community.arm.com/arm-community-blogs/b/graphics-gaming-and-vr-blog/posts/introducing-arm-accuracy-super-resolution)
...
- [UE 5.8 悄悄内置了 MCP 协议：OpenClaw + Unreal Engine AI 工具链深度解析](https://mp.weixin.qq.com/s?__biz=Mzg3ODc1NDg5Mw==&mid=2247484716&idx=1&sn=cbe70cb203e2bec85c5666d3d32c98ba)
...
- [非真实感渲染(NPR)](https://www.zhihu.com/column/c_1221870230877913088)
- [Non-Photorealistic Rendering Arnold: Techniques](https://reelmind.ai/blog/non-photorealistic-rendering-arnold-techniques)
- [Making 3D animation look painterly (it's easier than you think)](https://www.youtube.com/watch?v=s8N00rjil_4)
...
- [CV｜一堆“小云团”，怎么还原真实世界？](https://mp.weixin.qq.com/s?t=pages/image_detail&scene=23&__biz=MzcwMzQ1MjI2Ng==&mid=2247484273&idx=1&sn=a6184c4534b098eccc854a1ba5149e74)
...
- [助力腾讯游戏打造自研光照烘焙系统](https://zhuanlan.zhihu.com/p/198901119)
- [【翻译】可微渲染：理论与应用](https://zhuanlan.zhihu.com/p/1986381759219249906)
